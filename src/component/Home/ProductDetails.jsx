  ...
  return (
    <div className='grid lg:grid-cols-2 sm:grid-cols-1 mt-10 justify-items-center sm:px-5'>
        <div>
            ...
            <h1 className='text-3xl text-accent text-center font-bold'>{product.productName}</h1>
            <h1 className='text-xl mt-3 text-accent font-bold'><b>Price </b><span className="text-xl">&#2547;</span>{" "}
            ...
            <p className='text-accent'><b>Details : </b>{product.productDetails}</p>
        </div>
        <div className='w-3/4'>
        <h1 className='text-3xl text-accent text-center font-bold'>Place order</h1>
